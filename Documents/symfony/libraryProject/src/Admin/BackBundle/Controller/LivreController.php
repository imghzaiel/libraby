...
use Admin\BackBundle\Entity\Livre;
...
class LivreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $livres = $em->getRepository('AdminBackBundle:Livre')->findAll();
    ...
    {
        $livre = new Livre();
        $form = $this->createForm('Admin\BackBundle\Form\LivreType', $livre);
    ...
    {
        $deleteForm = $this->createDeleteForm($livre);
        $editForm = $this->createForm('Admin\BackBundle\Form\LivreType', $livre);
