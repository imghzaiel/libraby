...
use Admin\BackBundle\Entity\Categorie;
...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('AdminBackBundle:Categorie')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Admin\BackBundle\Form\CategorieType', $categorie);
    ...
    {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('Admin\BackBundle\Form\CategorieType', $categorie);
